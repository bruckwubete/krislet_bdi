...
+!return_to_flag : not(viz("flag", "prb")) & goal_l <- !set_up.
+!return_to_flag : not(viz("flag", "prb")) & goal_r <- !set_up.
+!return_to_flag : not(viz("flag", "prb")) <- turn_to_flag(prb); !return_to_flag.
+!return_to_flag : viz("flag", "prb") & distance("flag", "prb", X) & X > 1.0 & direction("flag", "prb", Y) & Y > 5.0 <- turn_to_flag(prb); !return_to_flag.
+!return_to_flag : viz("flag", "prb") & distance("flag", "prb", X) & X > 1.0 & direction("flag", "prb", Y) & Y <= 5.0 <- dash; !return_to_flag.
+!return_to_flag : viz("flag", "prb") & distance("flag", "prb", X) & X <= 1.0 <- !defence.
